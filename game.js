...
function refreshScoreData(team1, team2) {
    if (team1) {
        document.getElementById("nameFirstTeam").innerText = team1.name;
        document.getElementById("scoreFirstTeam").innerText = team1.coinsCollected || 0;
        document.getElementById("lifesFirstTeam").innerText = team1.currentLives;
    }

    if (team2) {
        document.getElementById("nameSecondTeam").innerText = team2.name;
        document.getElementById("scoreSecondTeam").innerText = team2.coinsCollected || 0;
        document.getElementById("lifesSecondTeam").innerText = team2.currentLives || 0;
    }
};
